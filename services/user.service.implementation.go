...
func (u *UserServiceImpl) GetUser(name *string) (*models.User, error) {
	var user *models.User	// "Name" comes from params
	query := bson.D{bson.E{Key: "user_name", Value: name}}	// check library documentation to understand query
...
func (u *UserServiceImpl) GetAll() ([]*models.User, error) {
	...
	cursor, err := u.usercollection.Find(u.ctx, bson.D{{}})	// get Users from db
	if err != nil {
		return nil, err
	}
